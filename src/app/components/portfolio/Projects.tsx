        ...
        <div className="mt-12">
            ...
            <div className="w-full relative rounded-xl bg-[#f1f1f1] h-auto p-4 my-8">
                <div className="flex justify-between items-center">
                    ...
                    <div>
                        <a href="https://github.com/vedanthanekar45/the-wanderer" target="_blank" rel="noopener noreferrer">
            ...
            <div className="w-full relative rounded-xl bg-[#f1f1f1] h-auto p-4 my-4">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex">
                        <a href="https://github.com/vedanthanekar45/BookTok" target="_blank" rel="noopener noreferrer">
                            <LuGithub className="text-black text-3xl mr-8 font-thin" />
                        </a>
                        <a href="https://booktalk-66lw.onrender.com/" target="_blank" rel="noopener noreferrer">
            ...
            <div className="w-full relative rounded-xl bg-[#f1f1f1] h-auto p-4 my-8">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex">
                        <a href="https://github.com/vedanthanekar45/NovelNest" target="_blank" rel="noopener noreferrer">
                            <LuGithub className="text-black text-3xl mr-4 font-thin" />
                        </a>
                        <a href="https://novelnest-tr48.onrender.com/" target="_blank" rel="noopener noreferrer">
                            <IoOpenOutline className="text-black text-3xl mr-4 font-thin" />
                        </a>
                    </div>
                </div>
             ...
             <div className="w-full relative rounded-xl bg-[#f1f1f1] h-auto p-4 my-8">
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-6">
                        <h1 className="text-black text-3xl">Agora</h1>
                        <div className="flex items-center space-x-3 mt-[5px] text-2xl">
                            <SiDjango className="text-green-800" />
                            <BiLogoPostgresql className="text-blue-700" />
                        </div>
            ...
            <div className="w-full relative rounded-xl bg-[#f1f1f1] h-auto p-4 my-8">
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-6">
                        <h1 className="text-black text-3xl">Scheduler (in Development)</h1>
                        <div className="flex items-center space-x-3 mt-[5px] text-2xl">
